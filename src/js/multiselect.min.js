...
Multiselect.prototype = {
    _createUI: function() {
        ...
        var b = document.createElement('div');
            b.className = 'multiselect-block';
        m_helper.insertAfter(b, this._item);
        b.appendChild(a);
    ...
    _createWrapper: function() {
        var a = document.createElement('div');
            a.className = 'multiselect-wrapper';
    ...
    _appendEvents: function() {
        var a = this;
       document.getElementById('multiselect-input-div').addEventListener('click', function() {
            a._showList(a)
    ...
    _hideList: function(a, b) {
        m_helper.setUnactive(document.getElementById(a._getItemListIdentifier()).parentElement), m_helper.show(document.getElementById(a._getItemListIdentifier()).querySelector('span')), m_helper.show(document.getElementById(a._getItemListIdentifier()).querySelector('hr')), m_helper.showAll(document.getElementById(a._getItemListIdentifier()).querySelectorAll('li')), a._updateText(a), b && b.stopPropagation()
    },
    _updateText: function(a) {
        ...
        b.length == document.getElementById(a._getItemListIdentifier()).querySelectorAll('ul li').length && (c = this._item.dataset.full), document.getElementById(a._getInputFieldIdentifier()).value = c ? c : ''
    },
